...
DNS_RECORD=$(grep "address=/$MACH/" /etc/dnsmasq.d/nordeck-jvb | head -n1)
IP=${DNS_RECORD##*/}
...
# tcp/9090
nft delete element nordeck-nat tcp2ip { 9090 } 2>/dev/null || true
nft add element nordeck-nat tcp2ip { 9090 : $IP }
nft delete element nordeck-nat tcp2port { 9090 } 2>/dev/null || true
nft add element nordeck-nat tcp2port { 9090 : 9090 }
# udp/10000
